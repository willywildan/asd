...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item ">
        <a class="nav-link" href="<?php echo base_url();?>index.php/Home/bdpb">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo site_url('Semuabencana/semuabencanabdpb') ?>">Semua bencana<span class="sr-only"></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url();?>index.php/kelolabencana">Kelola Bencana</a>
      </li>
        <li class="nav-item">
        <a class="nav-link" style="color: white;padding-left:20px; font-family: roboto; font-size: 18px;" href="<?php echo site_url('About/aboutbdpb')?>">About</a>
      </li>
      <li>
    ...
    </ul>  <div style="padding-right:  50px;color: white; "><h6 class="display-5" style="font-size: 18px">Hai, <?php echo $this->session->userdata('username')?> !</h6></div>
    <div class="dropdown show">
  <a class=" dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    <img src="<?php echo base_url();?>/assets/img/bnpb.jpg" class="rounded-circle" width="60px">
  </a>
