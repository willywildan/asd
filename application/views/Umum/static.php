...
<link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent" >
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" style="color: white;padding-left:20px; font-family: roboto; font-size: 18px;" href="<?php echo base_url();?>index.php/about ">About</a>
      </li>
 ...
 <div style="padding-right:  50px;color: white; "><h5 class="display-5"></h5></div>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    <a class="dropdown-item" href="<?php echo base_url();?>index.php/login">Sign in</a>
        ...
        <a class="btn btn-success" style="color: white;" href="<?php echo base_url();?>index.php/semuabencana" role="button">Donasi sekarang</a>
