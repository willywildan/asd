 <section class="profil " id="profil">
  ...
  <ul class="pagination justify-content-center">
    ...
    <li class="page-item active"><a class="page-link" href="<?php echo base_url();?>index.php/listtanahlongsor">Tanah Longsor</a></li>
    ...
    <li class="page-item"><a class="page-link" href="<?php echo base_url();?>index.php/listkekeringan">Kekeringan</a></li>
        ...
        <?php foreach ($bencanatanah->result() as $key) { ?>
          ...
          <div class="list-group">
            <a href="<?php echo base_url();?>index.php/rincian" class="list-group-item list-group-item-action"> <?php echo $key->nama_tanahLongsor;?></a>
