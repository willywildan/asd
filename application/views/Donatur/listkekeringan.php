<section class="profil " id="profil">
  ...
  <ul class="pagination justify-content-center">
    ...
    <li class="page-item active"><a class="page-link" href="<?php echo site_url('ListKekeringan/listkekeringandonatur')?>">Kekeringan</a>
    </li>
        ...
        <div class="col-sm-12">  
          ...
          <div class="list-group">
            ...
            <a href="<?php echo site_url('Rincian/rinciandonatur')?>" class="list-group-item list-group-item-action">
              <?php echo $key->nama_kekeringan;?> </a>
