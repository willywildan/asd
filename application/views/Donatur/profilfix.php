      ...
      <div class="container ">
        ...
        <form>
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="validationDefault01" value="<?php echo $this->session->userdata('username')?>"  required> 
            </div>
          </div>
          <div class="form-group row">
            <label for="validationDefault01" class="col-sm-2 col-form-label">NIK</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="validationDefault01" placeholder="<?php echo $this->session->userdata('nik')?>" required>
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="Email" class="form-control" id="validationDefault01" placeholder="<?php echo $this->session->userdata('email')?>" required>
            </div>
          </div>
          <div class="form-group row">
            <label for="validationDefault01" class="col-sm-2 col-form-label">Alamat</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="validationDefault01" placeholder="<?php echo $this->session->userdata('alamat')?>" required>
            </div>
          </div>
          <div class="form-group row">
