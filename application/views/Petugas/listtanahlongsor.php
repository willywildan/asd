 <section class="profil " id="profil">
  ...
  <ul class="pagination justify-content-center">
    ...
    <li class="page-item active"><a class="page-link" href="<?php echo site_url('ListTanahLongsor/listtanahlongsorpetugas')?>">Tanah Longsor</a>
    </li>
    ...
    <li class="page-item"><a class="page-link" href="<?php echo site_url('ListKekeringan/listkekeringanpetugas')?>">Kekeringan</a>
        ...
        <?php foreach ($bencanatanah->result() as $key) { ?>
          ...
          <div class="list-group">
            <a href="<?php echo site_url('Rincian/rincianpetugas')?>" class="list-group-item list-group-item-action"> <?php echo $key->nama_tanahLongsor;?></a>
