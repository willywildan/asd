...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item ">
        <a class="nav-link" href="<?php echo site_url('Home/petugas') ?>">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo site_url('Semuabencana/semuabencanapetugas') ?>">Semua bencana<span class="sr-only"></a>
      </li>
        <li class="nav-item">
  ...
  <a class=" dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    <img src="<?php echo base_url();?>/assets/img/petugas.jpg" class="rounded-circle" width="60px">
  </a>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    <a class="dropdown-item" href="<?php echo base_url();?>index.php/daftardonatur">Daftar Donatur</a>
